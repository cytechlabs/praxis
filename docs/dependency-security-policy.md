...
(`…dependabot[bot]@users.noreply.github.com`). The match is Dependabot-specific,
...
4. **Majors:** major-version bumps may need code changes — treat as normal work,
   not a rubber-stamp.
...
# Owner:   <github-handle>
# Review:  <YYYY-MM-DD — re-evaluate/remove by this date>
CVE-XXXX-YYYYY
```
