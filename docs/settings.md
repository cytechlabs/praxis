---
title: Settings
description: General, timezone, connection, SSH identity, notification, and alert configuration.
---
...
Zero-trust CA config. Covered in depth in [SSH & Security](ssh-and-security.md):
...
The alert/webhook destinations tab. Every row is an AlertConfig that subscribes to a set of event types and routes matching events to Slack or a generic webhook. Covered in detail under [Alerts & Webhooks](monitoring-and-alerts.md#alerts-and-webhooks).
