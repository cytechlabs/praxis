  ...
  return (
    <div className="space-y-6">
      <Card>
        ...
        <CardBody>
          <div className="rounded-lg border border-border bg-black/30 p-3 mb-4 text-sm text-content-muted flex items-start gap-2">
          ...
          <div className="flex flex-wrap items-end gap-3">
            <div className="min-w-[12rem]">
              <label className="block text-xs uppercase tracking-wide text-content-subtle mb-1">Time range</label>
          ...
          {last && (
            <div className="mt-4 text-xs text-content-subtle flex items-center gap-2">
